(function($) {
    $.fn.OnlineQQ = function(options) {
        ...
        var $lanrenzhijiawarp = $("#lanrenzhijiawarp"),
            $lanrenzhijia_con = $("#lanrenzhijia_con"),
            $kflist = $lanrenzhijia_con.children("ul"),
            $lanrenzhijia_x = $("#lanrenzhijia_x"),
            $lanrenzhijia_btn = $("#lanrenzhijia_btn"),
            $lanrenzhijiawarp_w = $lanrenzhijiawarp.outerWidth() * 1 + 1;
